...
// Returns the private 'App\Repository\Impression3DRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\Impression3DRepository.php';

return $this->privates['App\\Repository\\Impression3DRepository'] = new \App\Repository\Impression3DRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
